...
<div class="form-group travel-date-group" style="text-align: left;font-size:16px;">
    ...
    <input type="text" value="" class="form-control tleft default" placeholder="วันที่ประกาศเลิกบริษัท">
</div>
<div class="form-group" style="text-align: left;font-size:16px;">
...
<div class="form-group" style="text-align: left;font-size:16px;">
    <b>ตำแหน่งผู้ลงนาม</b>
    <input type="text" class="form-control" placeholder="กรรมการผู้มีอำนาจลงนาม" value="ผู้ชำระบัญชี">
</div>